...
folder_path = '/Users/leeshinhaeng/Desktop/aws-bedrock-tutorial-main/NDC_Project/Dataset/summarytext'
...
if os.path.isfile(file_path):
    ...
    folder_path = '/Users/leeshinhaeng/Desktop/aws-bedrock-tutorial-main/NDC_Project/Dataset/summarytext' # data 폴더 경로
...
def create_prompt(df, query):
    ...
    prompt = f"""\n\nHuman: 당신은 넥슨 개발자 컨퍼런스 내용을 바탕으로 게임업계에서 트렌드를 설명해주는 '겜트'라는 인공지능 언어 모델입니다. 누가 당신에게 누구냐고 물으면 겜트라고 답변하세요. 주어진 문서와 질문을 바탕으로 질문에 대한 답변을 간결하고 평문으로 요약해주세요.
    문서는 다음과 같습니다.
